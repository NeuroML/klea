...
flowchart TB
    ...
    subgraph Klea [Klea]
        ...
        agent["klea_agent<br/>Python / FastAPI / LangGraph<br/>General purpose agent (KleaAgent)<br/>includes former code_pkg  ---  WIP<br/>CLI: klea; serve: :8006"]
...
| `klea_agent` | `agent_pkg` | General purpose agent (`KleaAgent` over `BaseLangGraph`); **WIP** | `klea`, `klea-serve` (HTTP `:8006`) |
