#!/usr/bin/env python3
"""
RAG NiceGUI page composition.

This module *composes* the RAG web page from the shared
...
RAG-specific UI elements can be added here without touching
``klea_utils``.

File: klea_rag/ui/web/page.py
...
def setup_layout(
    ...
    """Build the RAG page UI: header, drawers, chat area, and footer.
