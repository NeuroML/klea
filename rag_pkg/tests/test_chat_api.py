#!/usr/bin/env python3
"""
Tests for the RAG chat API router (app-owned chat contract).
...
class TestChat:
    """Chat endpoint tests for the RAG chat contract."""
    ...
    async def test_query_passes_stored_model_overrides(self, client, app):
        ...
        store.set_override("test-user", "ov-chat", "chat", {"model": "ollama:qwen3"})
    ...
    async def test_query_when_not_ready(self, app, client):
        """POST /query returns 503 before the server is ready."""
